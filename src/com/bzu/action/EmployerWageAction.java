...
public class EmployerWageAction extends ActionSupport implements ModelDriven<EmployerWage> {

	private EmployerWage employerWage = new EmployerWage();
	@Override
	public EmployerWage getModel() {
		return employerWage;
	}
