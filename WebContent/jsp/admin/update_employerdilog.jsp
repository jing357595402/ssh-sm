...
<html>
	...
	<body>
		...
		<form action="${path }/employerAction_updateEmployer.action" target="mainFrame" onsubmit="javascript:window.close();">
		...
		<tr >
			<td>密码</td>
			<td><input type="password" name="password" value="${request.emp.password }"/>
			<input type="hidden" name="id" value="${request.emp.id }"/>
			</td>
		</tr>
		<tr >
			<td>家庭住址</td>
			<td><input type="text" name="adress" value="${request.emp.adress }"/></td>
		</tr>
		<tr >
			<td>电话</td>
			<td><input type="text" name="telephone" value="${request.emp.telephone }"/></td>
		</tr>
		<tr >
			<td>月薪</td>
			<td><input type="text" name="monthpay" value="${request.emp.monthpay }"/></td>
		</tr>
