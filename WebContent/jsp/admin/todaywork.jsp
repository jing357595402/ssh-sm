...
<html>
	...
	$(function() {
		...
		function showDialogForEdit(id){
			window.showModalDialog('${path }/employerAction_updateEmployerDialog.action?employer.id='+id,'','dialogWidth=450px;dialogHeight=350px;');
	}
	...
	<center>
	<body>
		<form action="${path }/employerAction_employerworks.action">
		<table class="ta">	
			<tr bgcolor="#D6DFF7">
