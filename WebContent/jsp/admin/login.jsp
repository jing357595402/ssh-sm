...
<div id="Layer1">
  <form action="${pageContext.request.contextPath}/adminAction_login.action" style="height:250px;width:480px;" method="post">
    <table width="441" height="110" border="0" cellpadding="0" cellspacing="0">
     
      <tr height="55px">
        
        <td align="left" valign="middle" > <input type="text" name="username"  style="border-color:#00CCFF;width:180px;height:30px;padding-top:3px;"/></td>
      </tr>
      <tr>
        <td align="left" valign="middle">  <input type="password" name="password"   style="border-color:#00CCFF;width:180px;height:30px;padding-top:3px;"/></td>
      </tr>
      <tr>
