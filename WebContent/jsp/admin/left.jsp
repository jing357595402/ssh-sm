            ...
            <TD id=submenu1><DIV class=sec_menu style="WIDTH: 158px">
                <TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
                  <TBODY>
                    ...
                    <TR>
                      <TD height=20><a href="${pageContext.request.contextPath }/employerAction_emplyerList.action" target="mainFrame">员工列表</a></TD>
                    </TR>
                    <TR>
        ...
        <TR>
          <TD id=submenu2>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
              <TBODY>
              <TR>
                <TD height=20><a href="${pageContext.request.contextPath }/employerAction_workList.action" target="mainFrame">添加今日出勤</a></TD>
              </TR>
              <TR>
                <TD height=20><a href="${pageContext.request.contextPath }/employerAction_todayWorkView.action" target="mainFrame">查看今日出勤</a></TD>
              </TR>
              <TR>
                <TD height=20><a href="${pageContext.request.contextPath }/employerAction_monthWorkMap.action" target="mainFrame">本月出勤统计</a></TD>
              </TR>
            ...
            <TD id=submenu3>
			 <DIV class=sec_menu style="WIDTH: 158px">
			   <TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
                 <TBODY>
                  <TR>
                     <TD height=20><a href="${pageContext.request.contextPath }/goodsAction_goodsList.action" target=mainFrame>货物列表</a></TD>
                   </TR>
                   <TR>
                     <TD height=20><a href="${pageContext.request.contextPath }/goodsAction_updateGoodsDialog.action" target=mainFrame>添加货物</a></TD>
                   </TR>
				   
                   <TR>
                     <TD height=20><A  href="${pageContext.request.contextPath }/intoGoodsAction_addIntoGoodsView.action"  target=mainFrame>添加进货</A></TD>
                   </TR>
                   <TR>
                     <TD height=20><A  href="${pageContext.request.contextPath }/intoGoodsAction_intoGoodsList.action"  target=mainFrame>本月进货列表</A></TD>
                   </TR>
          ...
          <TR>
            <TD id=submenu4><DIV class=sec_menu style="WIDTH: 158px">
                <TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
                  <TBODY>
                   <TR>
                      <TD height=20><a href="${pageContext.request.contextPath }/employerWageAction_createWage.action" target="mainFrame">生成员工本月工资</a></TD>
                    </TR>
                    <TR>
                      <TD height=20><a href="${pageContext.request.contextPath }/employerWageAction_employerWageList.action" target="mainFrame">本月员工工资列表</a></TD>
                    </TR>
                   <%--   <TR>
                      <TD height=20><a href="${pageContext.request.contextPath }/employerWageAction_createGoodsSpend.action" target="mainFrame">生成本月货物支出</a></TD>
                    </TR>
                    <TR>
                      <TD height=20><a href="${pageContext.request.contextPath }/employerWageAction_goodsSpendList.action" target="mainFrame">本月货物支出列表</a></TD>
                    </TR> --%>
<!--                     <TR>
          ...
          <TR>
            <TD id=submenu5><DIV class=sec_menu style="WIDTH: 158px">
                <TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
                  <TBODY>
                   <TR>
                      <TD height=20><a href="${pageContext.request.contextPath }/inputerAction_inputerList.action" target="mainFrame">销售商列表</a></TD>
                    </TR>
                    <TR>
